...
classifiers = [
               ...
               BaggingClassifier(random_state=seed, n_estimators=4),
               BaggingClassifier(random_state=seed, n_estimators=5),
               BaggingClassifier(random_state=seed, n_estimators=10),
               BaggingClassifier(random_state=seed, n_estimators=20),
               BaggingClassifier(random_state=seed, n_estimators=30),
               BaggingClassifier(random_state=seed, n_estimators=40),
               BaggingClassifier(random_state=seed, n_estimators=50),
               BaggingClassifier(random_state=seed, n_estimators=60),
               BaggingClassifier(random_state=seed, n_estimators=70),
               BaggingClassifier(random_state=seed, n_estimators=80),
               BaggingClassifier(random_state=seed, n_estimators=90),
               BaggingClassifier(random_state=seed, n_estimators=100),
               ]
...
df_ML.to_csv(r'results\gs_Bagging_n_estimators.csv')
